      ...
      <Box sx={{ maxWidth: "1200px", mx: "auto" }}>
        ...
        <Box
          sx={{
            ...
            background: "linear-gradient(180deg, #f9fafb, #21e8de)",
            
          }}
        >
          
          <FormLeftContent serviceIcon={FssaiIcon} serviceName={"Fssai & Food Licensing"} serviceContent={"FSSAI registration, food safety documentation, and approval support for food businesses of all sizes."}/>

        <EnquiryForm 
          serviceName="Fssai & Food Licensing"
          isFood={true}
